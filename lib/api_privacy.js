 ...
 */
exports.setPrivacySetting = async function (contact_email, contact_phone, contact_qq, contact_weixin, ext_file_media_id, notice_method, store_expire_timestamp, setting_list, privacy_ver, sdk_privacy_info_list){
 ...
 */
exports.getPrivacySetting = async function (privacy_ver){
    const token = await this.ensureAccessToken()
