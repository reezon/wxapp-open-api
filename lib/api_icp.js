...
exports.createIcpVerifyTask = async function (){
    const token = await this.ensureAccessToken()
    const url = this.wxappIcpPrefix + 'create_icp_verifytask?access_token=' + token.accessToken
    const data = {
 ...
 */
exports.uploadIcpMedia = async function (type, certificate_type, icp_order_field, filepath){
    const token = await this.ensureAccessToken()
    const url = this.wxappIcpPrefix + 'upload_icp_media?access_token=' + token.accessToken + '&type=' + type + '&certificate_type=' + certificate_type + '&icp_order_field=' + icp_order_field
  ...
  exports.cancelApplyIcpFiling = async function (){
      const token = await this.ensureAccessToken()
      const url = this.wxappIcpPrefix + 'cancel_apply_icp_filing?access_token=' + token.accessToken
      const data = {
...
exports.getIcpEntranceInfo = async function (){
    const token = await this.ensureAccessToken()
    const url = this.wxappIcpPrefix + 'get_icp_entrance_info?access_token=' + token.accessToken
...
exports.getOnlineIcpOrder = async function (){
    const token = await this.ensureAccessToken()
    const url = this.wxappIcpPrefix + 'get_online_icp_order?access_token=' + token.accessToken
...
exports.queryIcpServiceContentTypes = async function (){
    const token = await this.ensureAccessToken()
    const url = this.wxappIcpPrefix + 'query_icp_service_content_types?access_token=' + token.accessToken
...
exports.queryIcpCertificateTypes = async function (){
    const token = await this.ensureAccessToken()
    const url = this.wxappIcpPrefix + 'query_icp_certificate_types?access_token=' + token.accessToken
...
exports.queryIcpDistrictCode = async function (){
    const token = await this.ensureAccessToken()
    const url = this.wxappIcpPrefix + 'query_icp_district_code?access_token=' + token.accessToken
...
exports.queryIcpNrlxTypes = async function (){
    const token = await this.ensureAccessToken()
    const url = this.wxappIcpPrefix + 'query_icp_nrlx_types?access_token=' + token.accessToken
...
exports.queryIcpSubjectTypes = async function (){
    const token = await this.ensureAccessToken()
    const url = this.wxappIcpPrefix + 'query_icp_subject_types?access_token=' + token.accessToken
